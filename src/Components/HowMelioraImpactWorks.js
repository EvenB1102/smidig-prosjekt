            ...
            <div className="container">
                <div style={{display: "flex", flexFlow:"row wrap", flex: "1 0 100%", backgroundColor: "white"}} className="row">
                    <div style={{flex: "0 1 100%",textAlign: "center"}} classname="col">
                        <p style={{fontFamily: "Euclid Circular B", fontSize: "45px", fontStyle: "normal", lineHeight: "120%", fontWeight: "600", position: "relative", color: "#001826"}}>How Meliora Impact Works</p>
