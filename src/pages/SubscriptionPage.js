...
export function SubscriptionPage() {
    return(
        <body>
            ...
            <p style={{display: "flex", justifyContent: "center", fontSize: 18, paddingBottom: 130}}>If you have any questions, you can either  <a href="/Contact" style={{paddingLeft: 5, paddingRight: 5}}>contact us </a>  or we might have your answer on <a href="/FAQ"><u style={{paddingLeft: 5}}>frequently asked questions.</u></a></p>
        </body>
    )
}
